                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarProducts">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('create_product')}}" class="nav-link" data-key="t-create-product">Create Product</a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="{{route('products')}}" class="nav-link" data-key="t-create-product">View Product</a>
                                    </li>
